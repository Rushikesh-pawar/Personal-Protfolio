export const site = {
  ...
  tagline:
    "Building data systems, ML pipelines, and LLM-powered tooling. Currently a Master's student in Computer Science at Northeastern University.",
  location: "Boston, MA",
  ...
  links: {
    email: "rushikesh.pawar191999@gmail.com",
    schoolEmail: "pawar.rush@northeastern.edu",
