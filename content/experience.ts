...
export const experience: Experience[] = [
  {
    ...
    summary:
      "Worked on the AI & Big Data team at FEV — a German automotive engineering MNC — building data pipelines, LLM-based NLP systems, and validation frameworks for ADAS/AD development.",
    highlights: [
      ...
      "Developed and iterated on LLM-based NLP pipelines using HuggingFace Transformers and BERT — designing prompting strategies, structured output schemas, and evaluation frameworks to measure accuracy and reliability.",
      ...
      "Built a real-time monitoring dashboard for Tata Motors fusing live multi-sensor data — reduced fault detection time by 40%.",
  ...
  },
  {
    ...
    duration: "1 yr 1 mo",
    summary:
      "Year-long data analytics internship covering the full analytics workflow — collection, cleaning, statistical analysis, and dashboarding — for a multi-project consulting team.",
    highlights: [
      ...
      "Executed end-to-end data analytics workflows — collection, wrangling, visualization with Matplotlib, and presentation of actionable recommendations to stakeholders through written reports and verbal briefings.",
    ],
    skills: [
      "Python",
      "SQL",
